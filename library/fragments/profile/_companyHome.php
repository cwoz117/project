...
<script>
  ...
  function deleteObject(objRef, payloadID, woNum) {
    ...
    //Else path --> Workorders
      ...
      document.getElementById('locID').value = payloadID;
  ...
  function addLocation() {
    ...
    document.getElementById('contactnumID').value = "";
    document.getElementById('lCommandID').value = 0;
    document.getElementById('locHeaderID').innerHTML = "Add Location";
    document.getElementById('manage_location').style.display = 'block';
  }
  ...
  function editLocation(locID, address, contact) {
    document.getElementById('locHeaderID').innerHTML = "Edit Location";
    document.getElementById('lCommandID').value = 1;
    document.getElementById('locationID').value = locID;
    document.getElementById('addressID').value = address;
    document.getElementById('contactnumID').value = contact;
    document.getElementById('manage_location').style.display = 'block';
  }
    ...
    <div class="w3-container" style="min-height:400px;"> 
      ...
      <div class="w3-container w3-twothird" style="min-height:inherit;">
        <header class="w3-bar w3-card w3-round-large">
          ...
          <button class="w3-bar-item w3-button" onclick="switchView(3);"> View Locations </button>
        </header>
        ...
        <div id="locations" class="w3-container w3-bar w3-padding w3-margin w3-card w3-round-large" style="min-height:inherit; display:none">
          <script type="text/javascript">getInfo(3);</script>
        </div>
      ...
      <div class="w3-container w3-third" style="min-height:inherit;">
        <div class="w3-container w3-margin w3-right w3-card w3-round-large" style="min-height:inherit;">
          ...
          <ul class="w3-right-align" style="list-style: none;">
            ...
            <li><a href='#' onclick="addLocation();">Add Locations</a></li>
          </ul>
          </div>
        </div>
     </div>
...
<div class="w3-modal" id="manage_location">
  <div class="w3-modal-content w3-animate-top w3-round-large" style="width:400px">
    <div class="w3-container">
      <h2 id="locHeaderID"></h2>
    </div>
    <form class="w3-container w3-card-4 w3-padding" action="action/manage_location.php" method="POST">
      <input class="w3-hide" id="lCommandID" name="instruct">
      <input class="w3-hide" id="locationID" name="location" readonly>
      <label class="w3-text-grey w3-padding-small">Address</label>
      <input class="w3-input w3-border" id="addressID" type="text" name="address" required> 
      <label class="w3-text-grey w3-padding-small">Contact Number</label>
      <input class="w3-input w3-border" id="contactnumID" type="text" name="contact" pattern="[0-9]{1,10}" title="Must be numbers of length between 1 to 10 characters" required> 
...
<div class="w3-modal" id="deleteL">
  <div class="w3-modal-content w3-animate-top w3-round-large" style="width:300px">
    <div class="w3-container">
      <h2>Delete Payload</h2>
    </div>
    <form class="w3-container w3-card-4 w3-padding" action="action/manage_location.php" method="POST">
      <input class="w3-hide" type="text" name="instruct" value=2> 
      <label class="w3-text-grey w3-padding-small">Location ID </label>
      <input class="w3-round w3-input" id="locID" type="text" name="location" readonly> 
      <input class="w3-button w3-margin-top w3-round w3-align-left w3-blue" type="submit" value="Confirm">
      <a href="" class="w3-button w3-margin-top w3-round w3-align-right w3-red">Cancel</a>  
    </form>
  </div>
